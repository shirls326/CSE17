...
public class BST<E extends Comparable<E>> {
    ...
    */
    ...
    private int height(TreeNode node){
        ...
        int LHeight = height(node.left); // height of the left subtree
        int RHeight = height(node.right); // height of the right subtree
    ...
    private boolean isBalanced(TreeNode node){
        ...
        if(node == null){ // empty tree by definition is balanced
